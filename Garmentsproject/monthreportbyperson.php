...
<div class="container text-light" style="padding: auto;">
	<div>
		...
		<table class="table table-dark">
			<tr>
				...
				<td>
					<input class="form-control-sm bg-dark text-light" type="number" name="workerid" min="1" value="1">
				</td>
				<td>
					<h5>Month</h5>	
				</td>
	...
	<div>
		...
		if (isset($_POST['submit'])) :
			$id= validate($_POST['workerid']);
			$month= validate($_POST['monthid']);
			$year=validate($_POST['year']);
			$sql = "SELECT * FROM `worktime` WHERE `workers_id`='$id' AND MONTH(`date`)='$month' AND YEAR(`date`)='$year'";
		...
		<?php 
				foreach ($data as $dat) :  ?>
						<tr>
							...
							<td><?php echo $dat['included'] = 0 ? "included" : "Not included" ; ?></td>
						</tr>
		<?php		
				endforeach; ?>
					</tbody>
